    ...
    <View style={styles.container}>
      <Card style={styles.card}>
        <Card.Content style={styles.cardContent}>
          <Text variant="displaySmall" style={styles.textoCentralizado}>Jogo do Bicho</Text>
          {animalAtual ? (
            <>
              <Text variant="titleLarge" style={styles.textoCentralizado}>{animalAtual.nome}</Text>
              <Image source={{ uri: animalAtual.imagem }} style={styles.imagem} />
            </>
          ) : (
            <Text variant="bodyLarge" style={styles.textoCentralizado}>Nenhum animal gerado ainda</Text>
          )}
        </Card.Content>
        <Card.Actions style={styles.cardActions}>
          <Button onPress={resetar} mode="contained" style={styles.botao}>Resetar</Button>
          <Button onPress={gerarAnimal} mode="contained" style={styles.botao}>Gerar</Button>
        </Card.Actions>
      </Card>
    </View>
  );
